...
CATEGORIES = {
    ...
    "hitlist":   {"folder": "old bangers/Hitlist",   "cloud_folder": "Hitlist",   "prefix": "hit",       "default_artist": "Divine Voice",           "default_album": "Divine Whispers"},
...
export const PLAYLIST_CATEGORIES = [
  ...
  {{ id: "hitlist", label: "Divine Whispers", fullName: "Divine Whispers", subtitle: "Sacred Melodies & Soulful Vibes", count: {len(all_tracks.get('hitlist', []))} }},
